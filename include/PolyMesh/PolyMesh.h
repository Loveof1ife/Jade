...
//=====================================================================
	...
	MVert *const vert(const size_t id) const { return (id < numVertices() ? vertices_[id] : nullptr); }
	const MEdge* edge(const size_t id) const { return (id < numEdges() ? edges_[id] : nullptr); }
	MPolyFace *const polyface(const size_t id) const { return (id < numPolygons() ? polygons_[id] : nullptr); }
...
//	unsigned long long int polyfaces_begin() {
